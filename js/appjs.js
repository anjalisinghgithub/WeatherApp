...
function getcurrentweather(lat,lon)
{
	...
	var url = "https://api.darksky.net/forecast/770f29b057c7302b69283d33f0892266/" + lat + "," + lon + "?exclude=[minutely,hourly,alerts,flags]";
	//console.log(url);
...
function getminuteweatherforthishour()
{
	...
	var q=0; var str='';
	var xmlhttp = new XMLHttpRequest();
	var url = "https://api.darksky.net/forecast/29ac8eefda50c40d963405e8a4f3b5d5/" + lat + "," + lon + "?exclude=[hourly,currently,daily,alerts,flags]";
	xmlhttp.onreadystatechange = function()
	{
		if (this.readyState == 4 && this.status == 200)
		{
...
function gethourweatherforthisweek()
{
	...
	var xmlhttp = new XMLHttpRequest();
	var url = "https://api.darksky.net/forecast/29ac8eefda50c40d963405e8a4f3b5d5/" + lat + "," + lon + "?exclude=[minutely,currently,daily,alerts,flags]&extend=hourly";
	xmlhttp.onreadystatechange = function()
	{
		if (this.readyState == 4 && this.status == 200)
		{
